...
(function(window) {
  ...
  const translations = {
    es: {
      ...
      "affiliate.section_title": "🛒 Impresoras 3D y Filamentos Recomendados",
      "affiliate.section_desc": "Equipamiento probado y materiales con contraste óptico garantizado para fabricar tus códigos QR 3D con acabado profesional.",
      "affiliate.printer1_badge": "★ Mejor Opción Multicolor",
      "affiliate.printer1_title": "Bambu Lab A1 / A1 Mini (con AMS)",
      "affiliate.printer1_desc": "La combinación ideal para imprimir archivos .3MF multicolor en 2 colores de forma 100% automática sin pintar a mano.",
      "affiliate.printer1_btn": "Ver Oferta en Tienda Oficial",
      "affiliate.printer2_badge": "⚡ Mejor Calidad / Precio",
      "affiliate.printer2_title": "Creality Ender 3 V3 / Kobra",
      "affiliate.printer2_desc": "Impresora rápida y fiable para placas y llaveros monocolor con cambio de filamento por pausa de capa (M600).",
      "affiliate.printer2_btn": "Ver en Amazon",
      "affiliate.filament_badge": "🔬 Contraste Óptico 100%",
      "affiliate.filament_title": "Pack Dúo PLA+ Blanco Nieve y Negro",
      "affiliate.filament_desc": "Filamentos de alta opacidad diseñados para evitar transparencias y asegurar lectura óptica instantánea en cámaras.",
      "affiliate.filament_btn": "Ver Pack en Amazon",
      "affiliate.magnets_badge": "🧲 Fijación Magnética",
      "affiliate.magnets_title": "Imanes de Neodimio N52 (6×2 mm)",
      "affiliate.magnets_desc": "Ajuste perfecto a presión para el formato de placa magnética en neveras, pizarras y expositores metálicos.",
      "affiliate.magnets_btn": "Ver Kit de Imanes",
      "affiliate.disclaimer": "* Enlaces recomendados: al adquirir materiales a través de estos enlaces apoyas el mantenimiento gratuito de QR3D Studio sin coste extra para ti.",
            // Hardware & Affiliate Showcase
      "affiliate.section_title": "🛒 Recommended 3D Printers & Filaments",
      "affiliate.section_desc": "Tested hardware and high-opacity materials guaranteed for effortless camera scanning and professional 3D finishes.",
      "affiliate.printer1_badge": "★ Best Multi-Color Pick",
      "affiliate.printer1_title": "Bambu Lab A1 / A1 Mini (with AMS)",
      "affiliate.printer1_desc": "The ultimate setup to print dual-color .3MF files automatically with zero manual color painting required.",
      "affiliate.printer1_btn": "View on Official Store",
      "affiliate.printer2_badge": "⚡ Best Value Pick",
      "affiliate.printer2_title": "Creality Ender 3 V3 / Kobra",
      "affiliate.printer2_desc": "Fast and reliable 3D printer for single-color stands and keychains using layer filament change (M600).",
      "affiliate.printer2_btn": "View on Amazon",
      "affiliate.filament_badge": "🔬 100% Optical Contrast",
      "affiliate.filament_title": "Snow White & Jet Black PLA+ Duo",
      "affiliate.filament_desc": "High-opacity filaments engineered to eliminate light bleed and ensure instant smartphone camera scanning.",
      "affiliate.filament_btn": "View Pack on Amazon",
      "affiliate.magnets_badge": "🧲 Strong Magnetic Fit",
      "affiliate.magnets_title": "N52 Neodymium Magnets (6×2 mm)",
      "affiliate.magnets_desc": "Snug press-fit for the magnetic fridge format on refrigerators, whiteboards, and metal counters.",
      "affiliate.magnets_btn": "View Magnet Kit",
      "affiliate.disclaimer": "* Recommended links: purchasing materials through these links supports the free development of QR3D Studio at no extra cost to you.",
